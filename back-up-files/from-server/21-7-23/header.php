...
<head>
  ...
  <meta property="og:image" itemprop="image" content="https://www.hararehurricane.com/images/images/hh-logo.png">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="menutext"><a href="zim-afro">Point Table</a></li>
                    <li class="menutext last"><a href="zim-afro">Statistics</a></li>
                  </ul>
                </li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="menutext"><a href="about#about-us">About Team</a></li>
                    <li class="menutext"><a href="about#team-owners">Owners</a></li>
                    <li class="menutext"><a href="about#about-t10">About T10</a></li>
                    <li class="menutext"><a href="about#about-zimafro">About ZimAfro T10</a>
                    </li>
