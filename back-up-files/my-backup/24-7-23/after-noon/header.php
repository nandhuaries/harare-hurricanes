              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="menutext"><a href="javascript:void(0)">News</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="menutext"><a href="javascript:void(0)">Point Table</a></li>
                    <li class="menutext last"><a href="javascript:void(0)">Statistics</a></li>
                  </ul>
                </li>
