...
<div class="hero overlay banner" style="height: 75vh !important;">
    <div class="container">
...
<div class="site-section">
    ...
    <div class="container mb-3">
        <div class="row">
            <div class="col-12">
                <!-- <embed type="video/mp4" src="https://player.vimeo.com/progressive_redirect/playback/843951200/rendition/1080p/file.mp4?loc=external&log_user=0&signature=95f6f1541fbca46a54a1935f79dd7115359889c41685fffa88c14582bea8f04e" width="100%" height="400"> -->
                <!-- <iframe src="https://vimeo.com/843951200/41ac6895df?share=copy" frameborder="0"></iframe> -->
                <video style="height: auto; width: 100%;" autoplay loop plays-inline>
            ...
            <div class="col-lg-6 ml-auto bann overlay rounded mb-5" style="background-image: url(images/bg/common-bg-crop.jpg); background-size: cover; background-position: center; position:relative;">
                <div class="innerBann p-3 row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        <a href="songs/minus-without-harrare.wav" class="btn btn-primary py-3 px-5 m-2" download="">Download Track</a>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="color:black" class="modal-title" id="exampleModalLabel">Lyrics</h5>
